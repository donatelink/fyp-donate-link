// Country list (name, ISO-2 code, dial code, flag emoji) — alphabetical by name.
// Use COUNTRIES for both the Country dropdown and the PhoneInput dial selector.
...
// Default dial code for the PhoneInput when no phone is set.
export const DEFAULT_DIAL = "+92";

// Parse a stored phone string like "+92 3001234567" into { dial, number }.
export function parsePhone(value) {
  ...
  return { dial: DEFAULT_DIAL, number: String(value).replace(/\D/g, "") };
}
